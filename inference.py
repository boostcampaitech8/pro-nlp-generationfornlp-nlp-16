...
def main(cfg: DictConfig):
    ...
    checkpoint_step = cfg.inference.checkpoint_step # "best" 또는 특정 스텝 숫자 (예: 1000)

    test_data_path = hydra.utils.to_absolute_path(cfg.data.test_path) # 테스트 데이터 경로
    ...
    torch_dtype = cfg.inference.get('torch_dtype', 'float16')  # default to float16
